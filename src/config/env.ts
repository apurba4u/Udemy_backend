...
export const env = {
  ...
  BETTER_AUTH_URL: process.env.BETTER_AUTH_URL || 'https://backend-ten-tawny-84.vercel.app',
  ...
  FRONTEND_URL: process.env.FRONTEND_URL || 'https://frontend-opal-theta-mydgygpet3.vercel.app',
